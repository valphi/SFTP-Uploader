...
# Create the zip file
zip -r "$ZIP_FILE" run_macos.command schedule_macos.command remove_schedule_macos.command SftpClient.jar "$JRE_TEMP_FOLDER" user_indicator macro_indicator portfolio
if [ $? -eq 0 ]; then
