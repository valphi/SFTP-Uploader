...
# Define variables
ZIP_FILE="archive_windows_with_tests.zip"
...
# Create the zip file including TestFilesWindows and TestPlanWindows.md
zip -r "$ZIP_FILE" run_windows.bat schedule_windows.bat remove_schedule_windows.bat SftpClient.jar "$JRE_TEMP_FOLDER" user_indicator macro_indicator portfolio README_WINDOWS.md README_WINDOWS.pdf TestFilesWindows TestPlanWindows.md
if [ $? -eq 0 ]; then
